...
<main class="main-left">
    ...
    <section id="home" class="home-banner">
        <div class="hb-top-fixed d-flex">
            <div class="hb-info">
                <label>+1(917) 607 8176</label>
                <label>info@urinbaeva.com</label>
            </div>
            <div class="hb-lang">
                <ul class="nav">
            ...
            <div class="row full-screen align-items-center">
                <div class="col-lg-7">
                    <div class="type-box">
                        ...
                        <h1 class="font-alt">Zarina Urinbaeva</h1>
                        <p class="lead">Full-stack Developer | PHP Devoloper | Freelancer</p>
                        <p class="desc">As a skilled PHP developer, I bring expertise in creating dynamic and robust web applications using PHP and related technologies.  I am passionate about staying up-to-date with the latest industry trends and best practices</p>
                        <div class="btn-bar">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="about-me">
                        ...
                        <div class="info">
                            <p>Full Stuck Devoloper</p>
                            <h3>Zarina Urinbaeva</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 ml-auto">
                    <div class="about-info">
                        ...
                        <div class="about-text">
                            <p>
                                As a developer with hands-on experience in HTML, CSS, JavaScript, PHP, and SQL, I'm eager to take on new challenges and further develop my skills. I am proficient in creating responsive web pages, dynamic user interfaces, and back-end functionality using PHP and databases with SQL.
                            </p>
                            <p>
                                My attention to detail and commitment to writing clean, efficient code make me a reliable team player. I am eager to learn and grow, and I'm excited to contribute to your development projects.
                            </p>
                        </div>
                        <div class="info-list">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <ul>
                                        <li>
                                            <label>Phone: </label>
                                            <span>+1(917) 607 8176</span>
                                        </li>
                                        <li>
                                            <label>Email: </label>
                                            <span>zurinbaeva33@gmail.com</span>
                                        </li>
                                        <li>
                                            <label>Telegram: </label>
                                            <span>https://t.me/Zarina_Urinbaeva</span>
                                        </li>
                                        <li>
                                            <label>Website: </label>
                                            <span>www.urinbaeva.com</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 m-15px-tb">
                    <div class="feature-box-01">
                        ...
                        <div class="feature-content">
                            <h5>Web Design</h5>
                            <p>I specialize in creating visually appealing and user-friendly websites that captivate audiences and deliver exceptional user experiences. With expertise in HTML, CSS, and responsive design, I am skilled in crafting modern and aesthetically pleasing websites that are optimized for various devices and screen sizes. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 m-15px-tb">
                    <div class="feature-box-01">
                        ...
                        <div class="feature-content">
                            ...
                            <p> I am committed to writing clean, modular, and optimized code to ensure high performance and security. I am dedicated to delivering top-notch web solutions that exceed client expectations. Let's collaborate to bring your web development projects to life and create impactful online experiences for your users!</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 m-15px-tb">
                    <div class="feature-box-01">
                        ...
                        <div class="feature-content">
                            <h5>SEO Marketing</h5>
                            <p>I specialize in driving targeted traffic to websites and increasing online visibility. Leveraging my expertise in search engine optimization (SEO), digital marketing, and data analysis, I craft strategic marketing campaigns that deliver measurable results. From keyword research and on-page optimization to content creation and link building.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel" data-items="2" data-nav-dots="true" data-md-items="2" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="30" data-autoplay="true">
                <div class="testimonial-01 media">
                    <div class="avatar">
                        <img src="/nairo/static/img/team-1.jpg" title="" alt="">
                    </div>
                    <div class="media-body">
                ...
                <div class="resume-row">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-xl-9">
                            <div class="rb-right">
                                <h6>MYITEDU</h6>
                                <p>At MYITEDU, we are a cutting-edge IT company dedicated to providing innovative technology solutions to our clients. With our extensive expertise in web development, software development, and IT consulting, we help businesses thrive in the digital landscape. </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 m-15px-tb">
                    <ul class="aducation-box">
                        <li>
                            <span>2000-2011</span>
                            <h6>Uzb Public School</h6>
                            <p>Samarkand 74 School</p>
                        </li>
                        <li>
                            <span>2019-2021</span>
                            <h6>Cosmetologist</h6>
                            <p>Britany Beauty Academy</p>
                        </li>
                        <li>
                            <span>2022-2023</span>
                            <h6>Full Stuck Devoloper</h6>
                            <p>MYITEDU</p>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-5 col-xl-4 m-15px-tb">
                    <div class="contact-info">
                        <h4>Contact Me:</h4>
                        <p>I'm available to work remote or hybrid enviroment anywhere in the USA</p>
                        <ul>
                            <li class="media">
                                <i class="ti-map"></i>
                                <span class="media-body">Quuens, Rego Park, NY 11374</span>
                            </li>
                            <li class="media">
                                <i class="ti-email"></i>
                                <span class="media-body">info@urinbaeva.com</span>
                            </li>
                            <li class="media">
                                <i class="ti-mobile"></i>
                                <span class="media-body">+1(917) 607 8176</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="google-map">
                        <div class="embed-responsive embed-responsive-21by9">
                            <iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d6047.181603308365!2d-73.86094309233962!3d40.72702374026161!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sus!4v1682520530137!5m2!1sen!2sus" allowfullscreen=""></iframe>
                        </div>
                    </div>
                </div>
            </div>
